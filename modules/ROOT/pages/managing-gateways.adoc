...
For details on Cloud Extender, see the *Configuring a New Connection on a Private Network* in xref:creating-and-configuring-a-gateway.adoc[Creating and Configuring a Gateway].
