...
image::conf-privnet-1_2.png[conf_privnet-1.2]
...
+
image::test-conn-succ-1_2.png[test_conn_succ-1.2]
+
...
image::cloudext-auth-code-1_2.png[cloudext_auth_code-1.2]
...
For details on removing a Cloud Extender connection, see the *Cloud Extender* section in xref:managing-gateways.adoc[Managing Gateways].
