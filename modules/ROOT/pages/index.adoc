...
WARNING: Support for Anypoint Data Gateway continues in accordance with the MuleSoft https://www.mulesoft.com/legal/support-maintenance-terms[Product Support and Maintenance Terms]. However, this product is not available for new customers or upgrades.
