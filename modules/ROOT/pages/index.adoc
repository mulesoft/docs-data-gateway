...
NOTE: Support for Anypoint Data Gateway continues in accordance with MuleSoft's https://www.mulesoft.com/legal/support-maintenance-terms[Product Support and Maintenance Terms]. However this product is not available for new customers or upgrades.
